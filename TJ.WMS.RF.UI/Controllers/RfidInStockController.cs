...
{
    public class RfidInStockController: BaseController
    {
       ...
       // public static string RfidList;
        ...
        public ActionResult ValidateTrayNO(string TrayNO)
        {
            ...
            try
            {
                ...
                service.ExecuteBusinessProcess("RfidInStockTray");
        ...
        public ActionResult RfidInStockApply(string TrayNO)
        {
           // TempData["RfidList"] = "0001;0002;0003;0004;0005";
            ...
            try
            {
                ...
                business1.BusinessName = "RfidInStockApply";
                business1.Load();
                business1.Execute();
                TempData["RfidList"] = string.Empty;
                return Content("");
