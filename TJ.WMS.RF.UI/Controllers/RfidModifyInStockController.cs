...
{
    public class RfidModifyInStockController: BaseController
    {
       ...
       // public static string RfidList;
        ...
        public ActionResult ValidateTrayNO(string TrayNO)
        {
            ...
            try
            {
                ...
                service.ExecuteBusinessProcess("RfidModInStockTray");
        ...
        public ActionResult RfidModifyInStockApply(string TrayNO)
        {
           // TempData["RfidList"] = "0001;0002;0003;0004;0005";
            GetLoginInfo();
            if (Login_Info == null)
            {
            ...
            try
            {
                ...
                business1.BusinessName = "RfidModInStockApl";
                business1.Load();
                business1.Execute();
                TempData["RfidList"] = string.Empty;
                return Content("");
