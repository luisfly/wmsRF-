...
{
    public class StockMoveService:RFBase
    {
        public StockMoveService(string user_id, string user_name, string token)
        {
            SetParameter("Operator", user_id);
            SetParameter("OperName", user_name);

            this.Token = token;
            this.BusinessID = "RF_StockMove";
        ...
        public void Accept()
        {
            ExecuteBusinessProcess("RF_StockMove");
        //    //验证每一项
        //    ValidateUser();
